...
def extract_cms_data(directory: str, year: int):
    print("----------------------------------------")
...
def extract_all_years_cms():
    # Historical data is only consistent back to 2021
    extract_cms_data("./data/source/", 2025)
    extract_cms_data("./data/historical/2024", 2024)
    extract_cms_data("./data/historical/2023", 2023)
    extract_cms_data("./data/historical/2022", 2022)
    extract_cms_data("./data/historical/2021", 2021)
